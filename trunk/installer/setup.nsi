...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER VeohProxy
...
OutFile setup.exe
InstallDir $PROGRAMFILES\VeohProxy
CRCCheck on
XPStyle on
ShowInstDetails show
VIProductVersion 1.5.0.0
VIAddVersionKey ProductName VeohProxy
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ..\build\_hashlib.pyd
    File ..\build\_socket.pyd
    File ..\build\_ssl.pyd
    File ..\build\bz2.pyd
    File ..\build\default.exe
    File ..\build\library.zip
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $SMPROGRAMS\$StartMenuGroup\VeohProxy.lnk
    Delete /REBOOTOK $INSTDIR\w9xpopen.exe
    Delete /REBOOTOK $INSTDIR\VeohProxy.ico
    Delete /REBOOTOK $INSTDIR\unicodedata.pyd
    Delete /REBOOTOK $INSTDIR\python25.dll
    Delete /REBOOTOK $INSTDIR\MSVCR71.dll
    Delete /REBOOTOK $INSTDIR\library.zip
    Delete /REBOOTOK $INSTDIR\default.exe
